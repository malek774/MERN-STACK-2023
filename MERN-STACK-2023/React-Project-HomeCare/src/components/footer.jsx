...
const Footer = () => {
  return (
    <>
      <footer
        className="relative z-10 bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-20 "
        style={{ backgroundColor: "#f3f4f6" }}
      >
        <div className="container">
          <div
            className="flex flex-wrap -mx-1 p-3 ml-20 text-center "
          ...
          >
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <p className="text-base mb-7 text-body-color">
                  With a few clicks, you can quickly discover a wide range of
                  services or connect with those in need.
                </p>
            ...
            <LinkGroup header="Company">
              <NavLink link="/#" label="About Home Care" />
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <p className="text-base text-body-color">
                  {" "}
                  © {new Date().getFullYear()} Home Care{" "}
                </p>
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          <span className="absolute top-10 right-12 ">
            <svg
              width={75}
              height={75}
              viewBox="0 0 75 75"
